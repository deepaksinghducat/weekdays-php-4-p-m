...
$connection = mysqli_connect('localhost', 'root', '', 'crud'); // connect
...
//  $sql = "create table students( id int auto_increment primary key, name varchar(255) )";
...
// $sql = "insert into students(name) values('dummy1'), ('dummy2')";
...
$stmt =  mysqli_prepare($connection, "select * from students where id=? and name=?");
...
// $response = mysqli_fetch_all($data, MYSQLI_ASSOC);
